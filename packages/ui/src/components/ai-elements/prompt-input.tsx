...
export const PromptInputActionAddAttachments = ({
  ...
  const handleClick = useCallback<NonNullable<ComponentProps<typeof DropdownMenuItem>['onClick']>>(
    (e) => {
      e.preventDefault()
...
export type PromptInputActionAddScreenshotProps = ComponentProps<typeof DropdownMenuItem> & {
  label?: string
  onSelect?: ComponentProps<typeof DropdownMenuItem>['onClick']
}
